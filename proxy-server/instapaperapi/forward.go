...
// This file contains helper functions for forwarding received API calls to a real Instapaper instance (or a server with a compatible API).

func SendInstapaperRequest(host string, w http.ResponseWriter, r *http.Request, body string) {
